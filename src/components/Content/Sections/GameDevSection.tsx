...
const GameDevSection: React.FC = () => (
    <SectionContainer id={'section-gamedev'} title={'Game Dev'}>
        ...
        <ul className="list-group list-group-flush mb-3">
            ...
            <ChallengeListItem>
                Chaotic Fireballs: Players could summon multiple chaotic fireballs that hovered above their heads and followed their movements. I achieved this by implementing a geometric formula to calculate the position of each fireball in every frame.
                <code>
